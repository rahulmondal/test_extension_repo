# Welcome to Connect Extension project My Awesome Project

## Next steps

You may open your favourite IDE and start working with your project, please note that this project runs using docker.
You may modify at any time the credentials used to authenticate to connect modifying the file *my_awesome_project/.my_awesome_project_dev.env*.
...
```sh
$ docker compose up my_awesome_project_dev
```
...
```sh
$ docker compose run my_awesome_project_bash
```
...
```sh
$ docker compose run my_awesome_project_test
```
